...
# Set version info
set(EXATN_VERSION_MAJOR 1)
set(EXATN_VERSION_MINOR 0)
set(EXATN_VERSION_PATCH 0)
set(EXATN_VERSION_SUFFIX 41772a5)
set(EXATN_VERSION "1.0.0-41772a5")
...
set(EXATNRUNTIMELIB "libexatn-runtime.so")
set(EXATNNUMERICSLIB "libexatn-numerics.so")
set(EXATNGRAPHLIB "libexatn-runtime-graph.so")

set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS}  -DPATH_MAX=4096 -Wno-attributes -DNO_GPU -DEXATN_SERVICE")
...
set_target_properties(exatn::exatn-numerics PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${EXATN_INCLUDE_ROOT}/exatn;${EXATN_INCLUDE_ROOT}"
  INTERFACE_LINK_LIBRARIES "/usr/lib/x86_64-linux-gnu/openblas-pthread/libopenblas.so;/usr/lib/gcc/x86_64-linux-gnu/9/libgomp.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/gcc/x86_64-linux-gnu/9/libgomp.so;/usr/lib/x86_64-linux-gnu/libpthread.so;gfortran;/usr/lib/x86_64-linux-gnu/openblas-pthread/libopenblas.so"
)
