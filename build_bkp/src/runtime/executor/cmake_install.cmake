# Install script for directory: /home/schundu3/projects/ornl_tools/ORNL_QIS_Stack/exatn/src/runtime/executor
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "Unspecified" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so"
         RPATH "$ORIGIN/../lib:/home/schundu3/projects/ornl_tools/build/exatn/lib:/usr/lib/x86_64-linux-gnu/openblas-pthread")
  endif()
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/plugins" TYPE SHARED_LIBRARY FILES "/home/schundu3/projects/ornl_tools/ORNL_QIS_Stack/exatn/build/src/runtime/executor/libexatn-runtime-executor.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/plugins/libexatn-runtime-executor.so")
    endif()
  endif()
endif()
